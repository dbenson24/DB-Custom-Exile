...
move %Server%exile_server.pbo %ARMA%@ExileServer\addons\exile_server.pbo"
move %Server%exile_server_config.pbo %ARMA%@ExileServer\addons\exile_server_config.pbo"
move %Server%a3_dms.pbo %ARMA%@ExileServer\addons\a3_dms.pbo"

move %ProjectHome%\mpmissions\Exile.Altis.pbo %ARMA%\mpmissions\Exile.Altis.pbo"
