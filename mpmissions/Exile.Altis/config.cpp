...
{
	ExileClient_system_network_dispatchIncomingMessage = "core\override\OlympusClient_system_network_dispatchIncomingMessage.sqf";
	ExileClient_object_player_event_onInventoryOpened = "core\override\OlympusClient_object_player_event_onInventoryOpened.sqf";
...
class CfgNetworkCustomMessages
{
	/*
	class lockResponse
	{
